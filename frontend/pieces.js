...
function genererPieces(pieces){
    for (let i = 0; i < pieces.length; i++) {
        ...
        // AJOUT DU BOUTON 'AFFICHER LES AVIS'
...
// recuperer les avis dans le bouton
// for(let i = 0; i < pieces.length; i++){
...
// PIECES N'AYANT PAS DE DESCRIPTION
const boutonNoDescription = document.querySelector(".btn-desc");
